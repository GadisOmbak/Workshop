...
<body id="page-top">
    ...
    <!-- Custom Shipping Script -->
            ...
            <script>
            const supabaseUrl = 'https://dogqmxadstapacemmb.supabase.co';
    ...
    <script>
        $(document).ready(function() {
            ...
            // ✅ Only ONE delete-item function (Supabase)
                        ...
                        supabase.from('pengiriman')
                            ...
                            .then(({ error }) => {
                                if (error) {
                                    ...
                                    Swal.fire('Deleted!', 'Shipping record has been deleted.', 'success')
